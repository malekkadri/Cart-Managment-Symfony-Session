...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Book Appointment</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="hos-book-appointment.html" >Book Appointment</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Book Appointment</h1>                            </div>
                                ...
                                <div class="row">
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Service</label>
                                                <span class="desc"></span>
                                                <select class="form-control ">
                                                    <option value=""></option>
                                                    <option value="Dental Care">Dental Care</option>
                                                    <option value="Aging Solutions">Aging Solutions</option>
