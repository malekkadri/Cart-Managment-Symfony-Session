...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Hospital Events</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Hospital Events</h1>                            </div>
                        ...
                        <section class="box nobox">
                            <div class="content-body">
                                <div class="row">
                                    ...
                                    <div id='hos-events-calendar' class="col-md-10 col-sm-9 col-xs-9"></div>
