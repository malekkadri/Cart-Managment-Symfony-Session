...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : All Patients</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="hos-patients.html" >All Patients</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">All Patients</h1>                            </div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">All Patients</h2>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-1.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mrs. Brodeur</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-2.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Ms. Latshaw</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-3.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mrs. Clementina</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-4.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mr. Carri Busey</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-5.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Ms. Clay Dock</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-6.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mr. Mark Peskin</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-7.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mr. Arthur John.</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-8.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mr. Carri Busey</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-9.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Ms. Clay Dock</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-10.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mr. Mark Peskin</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-11.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mr. Arthur John.</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/patients/patient-12.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="hos-patient-profile.html">Mrs. Jonh A.</a></h4>
                                                        <span class='team-member-edit'><a href="hos-patient-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
