...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : WorldWide Centres</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="hos-centres.html" >Facility Locations</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">WorldWide Centres</h1>                            </div>
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="hos-centres.html">WorldWide Centres</a>
                                    </li>
                                    <li class="active">
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Facility Locations</h2>
