                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="hos-staff-edit.html" >Edit Staff Member</a>
                                </li>
                                <li>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Jason Yurey" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control ">
                                                    ...
                                                    <option selected="selected" value="House Keeping">House Keeping</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="field-1" value="Head of Dept.">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <img class="img-fluid" src="data/hos-staffs/staff-1.jpg" alt="" style="max-width:120px;">
                                                <div class="controls">
