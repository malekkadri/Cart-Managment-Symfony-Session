...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Doctor Schedule</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="hos-doc-schedule.html" >Doctor Schedule</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Doctor Schedule</h1>                            </div>
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="hos-doc-schedule.html">Appointment</a>
                                    </li>
                                    <li class="active">
                        ...
                        <section class="box nobox">
                            <div class="content-body">
                                <div class="row">
                                    ...
                                    <div id='hos-doc-schedule-calendar' class="col-md-10 col-sm-9 col-xs-9"></div>
