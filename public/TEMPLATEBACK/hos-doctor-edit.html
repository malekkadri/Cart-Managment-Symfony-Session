...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Doctor</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="hos-doctor-edit.html" >Edit Doctor</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Doctor</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Dr. Arthur Yurey" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control datepicker" data-format="mm/dd/yyyy" value="05/02/1985">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <img class="img-fluid" src="data/doctors/doctor-1.jpg" alt="" style="max-width:120px;">
                                                <div class="controls">
                                                    <input type="file" class="form-control" id="field-5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Speciality</label>
                                                <span class="desc">Eg: Surgeon</span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="Neurosurgery" id="field-1">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">The surgical specialties are the specialties in which an important part of diagnosis and treatmentby surgery.</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="http://www.example.com" id="field-61">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Doctor Account Info</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <form action="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="email@example.com" id="field-3">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" value="(123) 456-7878">
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Doctor Social Media Info</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
